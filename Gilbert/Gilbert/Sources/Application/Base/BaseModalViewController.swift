...
class BaseModalViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    let tapGesture = UITapGestureRecognizer(target: self, action: #selector(BaseModalViewController.handleTap(_:)))
...
extension BaseModalViewController: UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
